...
subgraph "路由与权限"
R_Index["路由配置<br/>src/router/index.ts"]
D_Permission["权限指令<br/>src/directives/permission.ts"]
D_Index["指令注册<br/>src/directives/index.ts"]
end
subgraph "状态与类型"
S_User["用户状态<br/>src/store/user.ts"]
T_Index["类型定义<br/>src/types/index.ts"]
end
subgraph "工具与API"
...
章节来源
- [src/router/index.ts](file://src/router/index.ts#L40-L76)
...
- [src/router/index.ts](file://src/router/index.ts#L10-L76)
- [src/directives/permission.ts](file://src/directives/permission.ts#L9-L31)
