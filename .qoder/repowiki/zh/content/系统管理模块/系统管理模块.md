...
UModel[用户数据模型<br/>src/types/index.ts]
end
subgraph "角色管理"
RIndex[角色管理页面<br/>src/views/system/role/index.vue]
RModel[角色数据模型<br/>src/types/index.ts]
end
subgraph "菜单管理"
MIndex[菜单管理页面<br/>src/views/system/menu/index.vue]
MModel[菜单数据模型<br/>src/types/index.ts]
end
subgraph "权限控制"
PDir[权限指令<br/>src/directives/permission.ts]
PReg[指令注册<br/>src/directives/index.ts]
Store[用户状态管理<br/>src/store/user.ts]
end
subgraph "路由配置"
...
- [src/router/index.ts](file://src/router/index.ts#L91-L116)
...
- [src/router/index.ts](file://src/router/index.ts#L48-L68)
...
**章节来源**
- [src/views/system/role/index.vue](file://src/views/system/role/index.vue#L1-L150)
- [src/types/index.ts](file://src/types/index.ts#L9-L11)
...
**章节来源**
- [src/views/system/menu/index.vue](file://src/views/system/menu/index.vue#L1-L161)
- [src/types/index.ts](file://src/types/index.ts#L32-L44)
