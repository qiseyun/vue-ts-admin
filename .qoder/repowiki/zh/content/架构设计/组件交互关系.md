...
B --> C["router/index.ts<br/>路由与导航守卫"]
C --> D["layout/index.vue<br/>布局容器"]
D --> E["views/*<br/>业务视图"]
A --> F["store/index.ts<br/>Pinia根仓库"]
F --> G["store/user.ts<br/>用户与权限状态"]
A --> H["directives/index.ts<br/>全局指令注册"]
H --> I["directives/permission.ts<br/>权限/角色指令"]
A --> J["types/index.ts<br/>类型定义"]
```
...
章节来源
- [src/router/index.ts](file://src/router/index.ts#L10-L11, #L28-L33, #L48-L53, #L68-L74)
