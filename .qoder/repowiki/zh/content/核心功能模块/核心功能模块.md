...
- [directives/auth.ts](file://src/directives/auth.ts)
...
- [router/auth.ts](file://src/router/index.ts#L1-L119)
...
- [api/auth.ts](file://src/api/auth.ts#L1-L18)
- [store/sys_user.ts](file://src/store/user.ts#L39-L50)
...
**图表来源**
- [router/auth.ts](file://src/router/index.ts#L91-L116)
...
- [directives/auth.ts](file://src/directives/index.ts#L1-L16)
...
**图表来源**
- [store/sys_user.ts](file://src/store/user.ts#L4-L68)
...
subgraph "应用代码"
Main[main.ts]
RouterIndex[router/auth.ts]
StoreUser[store/sys_user.ts]
