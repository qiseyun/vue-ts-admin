...
- [src/router/auth.ts](file://src/router/index.ts#L1-L4)
...
**章节来源**
- [src/layout/index.vue](file://src/layout/index.vue#L114-L133)
- [src/store/sys_user.ts](file://src/store/user.ts#L45-L50)
...
- [src/router/auth.ts](file://src/router/index.ts#L95-L120)
- [src/store/sys_user.ts](file://src/store/user.ts#L52-L55)
